...
def limnotoots(tweet=False, interactive=False, unseen=True):
    ...
    jobs_all = pd.concat(
        [jobs_ecoevo, jobs_earthenvscience, jobs_rss, jobs_csdms, jobs_rse, jobs_pangeo]
    )
        ...
        for i in range(len(res)):
            ...
            if interactive is True:
                ...
                if post_job in ["y", "i"]:
                    ...
                    d = dict(zip(keys, [source, date, posted, subject, body]))
...
def main():
    ...
    parser.add_argument("--unseen", default=True, action="store_false")
